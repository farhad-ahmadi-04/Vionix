...
function Hero() {
  return (
    <Container className="relative">
      <div className="flex justify-center  -mb-7 lg:-mb-14">
        <svg viewBox="0 0 500 250">
          ...
          <Link href={"category/shirt"} className="group">
        ...
        <svg viewBox="0 0 500 250">
          ...
          <Link href="category/t-shirt" className="group">
        ...
        <svg viewBox="0 0 500 250" className="hidden md:block">
          <defs>
      ...
      <div>
        <TypographyH3 className="font-tehran mr-32 sm:mr-64 md:m-0 text-center  lg:text-6xl">
          <WordRotate
            words={["بهترین باشید", "با ما", "با بهترین ها", "با", "VIONIX"]}
          />
        </TypographyH3>
      </div>
      <div className="flex justify-center items-end -mt-5">
        <svg viewBox="0 0 500 250">
          ...
          <Link href="category/jacket" className="group">
        ...
        <svg viewBox="0 0 500 200">
          ...
          <Link href="category/cap" className="group">
        ...
        <svg viewBox="0 0 500 250" className="hidden md:block">
          ...
          <Link href="category/hoodie" className="group">
